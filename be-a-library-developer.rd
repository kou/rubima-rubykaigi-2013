...
「よいソフトウェアを書けるようになる方法」について考える前に、まずは「よいソフトウェア」について考えてみました。「よい」の基準の1つは「Rubyらしい」です。「よい」を言いかえると「他と似ている」です。つまり、「よいソフトウェアを書けるようになる方法」は「似ているとはどういうことかを知って、それと同じようにすること」と言いかえることができます。
...
それでは、「よいソフトウェアを書けるようになる」ために「想像するよりも思い出す」というキーとなる考えを適用してみましょう。

[キーとなる考えを適用する](apply-the-key-idea.png)

「よいソフトウェアを書けるようになる」には、「似ているとはどういうことかを知って、それと同じようにする」とよいのでした。それでは、「似ているとはどういうことかを知る」ために何を経験すればいいでしょうか。

[知るためには何を経験すればよいか](what-experience-is-needed-for-knowledge.png)

それは、「Rubyユーザー」としての経験です。これは、すでにみなさん経験していますよね！
